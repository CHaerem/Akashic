...
export const PhotoIcon = ({ size = 22, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ChevronIcon = ({ direction = 'left', size = 14, className }: ChevronIconProps) => {
  // Base SVG points LEFT, rotate to get other directions
  const rotations = {
    left: 0,
    right: 180,
    up: -90,
