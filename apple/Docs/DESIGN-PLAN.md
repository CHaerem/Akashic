...
| **D9** | **Bundled demo journey — promoted to submission (2026-07-25)** (COMMERCIALIZATION-PLAN §4.2) — one read-only, deletable showcase journey so the empty globe sells the product. Both reviewers rate this the biggest conversion lever on the list; it is v1.1 only because the plan already tracks it and creation now works. | v1.1 |
